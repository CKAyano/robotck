...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_dhsetting.setObjectName("groupBox_dhsetting")
        self.horizontalLayout_dhsetting = QHBoxLayout(self.groupBox_dhsetting)
        self.horizontalLayout_dhsetting.setObjectName("horizontalLayout_dhsetting")
        ...
        self.verticalLayout_tab_fk.setObjectName("verticalLayout_tab_fk")
        self.groupBox_fk_input = QGroupBox(self.tab_fk)
        self.groupBox_fk_input.setObjectName("groupBox_fk_input")
        self.horizontalLayout_fk_input = QHBoxLayout(self.groupBox_fk_input)
        self.horizontalLayout_fk_input.setObjectName("horizontalLayout_fk_input")
        ...
        self.doubleSpinBox_fk_j_n = QDoubleSpinBox(self.groupBox_fk_input)
        self.doubleSpinBox_fk_j_n.setObjectName("doubleSpinBox_fk_j1")
        self.doubleSpinBox_fk_j_n.setDecimals(6)

        self.horizontalLayout_fk_input.addWidget(self.doubleSpinBox_fk_j_n)

        self.doubleSpinBox_fk_j2 = QDoubleSpinBox(self.groupBox_fk_input)
        self.doubleSpinBox_fk_j2.setObjectName("doubleSpinBox_fk_j2")
        ...
        self.groupBox_fk_ouput.setObjectName("groupBox_fk_ouput")
        self.gridLayout_fk_output = QGridLayout(self.groupBox_fk_ouput)
        self.gridLayout_fk_output.setObjectName("gridLayout_fk_output")
        self.checkBox_fk_round = QCheckBox(self.groupBox_fk_ouput)
        self.checkBox_fk_round.setObjectName("checkBox_fk_round")
        ...
        self.textBrowser_fk_result.setObjectName("textBrowser_fk_result")
        ...
        self.pushButton_fk_result.setObjectName("pushButton_fk_result")
        ...
        self.spinBox_fk_numjoint.setObjectName("spinBox_fk_numjoint")
        ...
        self.spinBox_fk_round.setObjectName("spinBox_fk_round")
        ...
        self.tab_ik = QWidget()
        self.tab_ik.setObjectName("tab_ik")
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", "Robot CK GUI", None))
        self.action_refresh.setText(
            QCoreApplication.translate("MainWindow", "\u91cd\u65b0\u6574\u7406", None)
        )
        self.groupBox_dhsetting.setTitle(QCoreApplication.translate("MainWindow", "D-H Settings", None))
        self.comboBox_dh.setItemText(
            0, QCoreApplication.translate("MainWindow", "< \u8acb\u9078\u64c7 D-H >", None)
        )

        self.pushButton_newDH.setText(QCoreApplication.translate("MainWindow", "\u65b0\u589e D-H", None))
        self.label_info.setText(
            QCoreApplication.translate("MainWindow", "\u8acb\u9078\u64c7\u6a5f\u68b0\u624b\u81c2D-H", None)
        )
        self.groupBox_fk_input.setTitle(QCoreApplication.translate("MainWindow", "\u8f38\u5165", None))
        self.label_fk_angle.setText(QCoreApplication.translate("MainWindow", "\u89d2\u5ea6\uff1a", None))
        self.radioButton_fk_rad.setText(QCoreApplication.translate("MainWindow", "\u5f33\u5ea6 (rad)", None))
        self.radioButton_fk_deg.setText(QCoreApplication.translate("MainWindow", "\u89d2\u5ea6 (deg)", None))
        self.groupBox_fk_ouput.setTitle(QCoreApplication.translate("MainWindow", "\u8f38\u51fa", None))
        self.checkBox_fk_round.setText(
            QCoreApplication.translate("MainWindow", "\u5c0f\u6578\u9ede\u4f4d\u6578", None)
        )
        self.comboBox_fk_result.setItemText(
            0, QCoreApplication.translate("MainWindow", "\u5ea7\u6a19", None)
        )
        self.comboBox_fk_result.setItemText(
            1, QCoreApplication.translate("MainWindow", "zyx\u6b50\u62c9\u89d2", None)
        )
        self.comboBox_fk_result.setItemText(
            2, QCoreApplication.translate("MainWindow", "\u65cb\u8f49\u77e9\u9663", None)
        )
        self.comboBox_fk_result.setItemText(
            3, QCoreApplication.translate("MainWindow", "\u9f4a\u6b21\u77e9\u9663", None)
        )
        self.comboBox_fk_result.setItemText(4, QCoreApplication.translate("MainWindow", "json", None))
        self.comboBox_fk_result.setItemText(5, QCoreApplication.translate("MainWindow", "yaml", None))

        self.label_fk_joint.setText(QCoreApplication.translate("MainWindow", "\u8ef8\uff1a", None))
        self.pushButton_fk_result.setText(
            QCoreApplication.translate("MainWindow", "\u8a08\u7b97\u7d50\u679c", None)
        )
        self.tabWidget_main.setTabText(
            self.tabWidget_main.indexOf(self.tab_fk),
            QCoreApplication.translate("MainWindow", "Forward Kinematics", None),
        )
        self.tabWidget_main.setTabText(
            self.tabWidget_main.indexOf(self.tab_ik),
            QCoreApplication.translate("MainWindow", "Inverse Kinematics", None),
        )
        self.tabWidget_main.setTabText(
            self.tabWidget_main.indexOf(self.tab_plot),
            QCoreApplication.translate("MainWindow", "Plot Robot", None),
        )
        self.menu_setting.setTitle(QCoreApplication.translate("MainWindow", "\u8a2d\u5b9a", None))
